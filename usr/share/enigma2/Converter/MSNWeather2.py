...
#
		...
		try:
			...
			msnweather['Sunrise'] = '%s%s%s%s' % (str(SRh).zfill(2), six.ensure_str(six.unichr(58)), SRx, SRm)
			msnweather['Sunset'] = '%s%s%s%s' % (str(SSh).zfill(2), six.ensure_str(six.unichr(58)), SSx, SSm)
			...
			msnweather['Moonrise'] = '%s%s%s%s' % (str(MRh).zfill(2), six.ensure_str(six.unichr(58)), MRx, MRm)
			msnweather['Moonset'] = '%s%s%s%s' % (str(MSh).zfill(2), six.ensure_str(six.unichr(58)), MSx, MSm)
